...
cuttlefish build --list      input.txt \
                 --kmer-len  61        \
                 --output    sccmec     \
                 --threads   8    \
                 --format 1
...
Rscript ./PANGWES/scripts/gwes_plot.r /data/biol-micro-genomics/kell7366/kmer_gwes/cdbg.ud_sgg_0_based /data/biol-micro-genomics/kell7366/kmer_gwes/cdbg_sgg_mean.png 0 "Mutual information" \
                    "" 0 "cdbg_sgg_mean (no sgg counts filtering)" \
